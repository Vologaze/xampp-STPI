...
$(document).ready(function(){
	...
	$('#itemDetailsitemName').keyup(function(){
		showSuggestions('itemDetailsitemName', showItemNumberSuggestionsFile, 'itemDetailsitemNameSuggestionsDiv');
	});
	...
	$('#purchaseDetailsItemName').keyup(function(){
		showSuggestions('purchaseDetailsItemName', showItemNumberForPurchaseTabFile, 'purchaseDetailsItemNameSuggestionsDiv');
	});
	
	// remove the item numbers suggestions dropdown in the purchase details tab
	// when user selects an item from it
	$(document).on('click', '#purchaseDetailsItemNameSuggestionsList li', function(){
		...
		getItemName('purchaseDetailsItemName', getItemNameFile, 'purchaseDetailsItemName');
		
		// Display the current stock for the selected item number
		getItemStockToPopulate('purchaseDetailsItemName', getStockFilex, 'purchaseDetailsCurrentStock');
	});
...
function addPurchase() {
	...
	$.ajax({
		...
		complete: function(){
			getItemStockToPopulate('purchaseDetailsItemName', getItemStockFile, 'purchaseDetailsCurrentStock');
...
function getPurchaseDetailsToPopulate(){
	...
	$.ajax({
		...
		success: function(data){
			...
			$('#purchaseDetailsItemName').val(data.itemNumber);
