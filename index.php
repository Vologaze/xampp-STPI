					...
					<div class="tab-content">
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-3">
								  <label for="itemDetailsUnit">Unit</label>
								  <input type="text" class="form-control" value="0" name="itemDetailsUnit" id="itemDetailsUnit">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsP.O.No. & Date">P.O.No. & Date</label>
								  <input type="text" class="form-control" name="itemDetailsP.O.No. & Date" id="itemDetailsP.O.No. & Date">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsInvoice Date">Invoice No.</label>
								  <input type="text" class="form-control" value="0" name="itemDetailsInvoice Date" id="itemDetailsInvoice Date">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsInvoice Date">Invoice Date</label>
								  <input type="date" class="form-control" name="itemDetailsInvoice Date" id="itemDetailsInvoice Date">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsInvoice Value">Invoice Value</label>
								  <input type="number" class="form-control" value='0' name="itemDetailsInvoice Value" id="itemDetailsInvoice Value">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsOther Chgr">Other Chgr</label>
								  <input type="number" class="form-control" value='0' name="itemDetailsOther Chgr" id="itemDetailsOther Chgr">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsTotal Amount">Total Amount</label>
								  <input type="number" class="form-control" value='0' name="itemDetailsTotal Amount" id="itemDetailsTotal Amount">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsRate">Rate</label>
								  <input type="text" class="form-control" name="itemDetailsRate" id="itemDetailsRate">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsTotal Depreciation">Total Depreciation</label>
								  <input type="number" class="form-control" value='0' name="itemDetailsTotal Depreciation" id="itemDetailsTotal Depreciation">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsW.D.V">W.D.V</label>
								  <input type="number" class="form-control" value='0' name="itemDetailsW.D.V" id="itemDetailsW.D.V">
								</div>
								<div class="form-group col-md-3">
								  <label for="itemDetailsValue of Insurance">Value of Insurance</label>
								  <input type="number" class="form-control" value='0' name="itemDetailsValue of Insurance" id="itemDetailsValue of Insurance">
								</div>
							  </div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <button type="button" id="addSaleButton" class="btn btn-success">Add Transfer</button>
